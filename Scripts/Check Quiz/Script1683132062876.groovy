...
WebUI.waitForElementVisible(findTestObject('Object Repository/Administrator/Page_Quizzes - TOVUTI - Administration/input_- Quiz Course Name -_title'), 
    0)

WebUI.verifyElementVisible(findTestObject('Object Repository/Administrator/Page_Quizzes - TOVUTI - Administration/input_- Quiz Course Name -_title'), 
