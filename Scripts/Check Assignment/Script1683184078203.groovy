...
WebUI.waitForElementVisible(findTestObject('Object Repository/Administrator/Page_Course Assignments - TOVUTI - Administration/input_Duplicate Assignment(s)_title'), 
    0)

WebUI.verifyElementVisible(findTestObject('Object Repository/Administrator/Page_Course Assignments - TOVUTI - Administration/input_Duplicate Assignment(s)_title'), 
